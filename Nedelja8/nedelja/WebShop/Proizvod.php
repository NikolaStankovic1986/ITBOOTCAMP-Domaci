<?php 
    ...
    class WebSite{
        function header(){
            echo "<header>";
            echo "<nav><ul><li><a href='index.php'>Dobro dosli u web-shop</a></li><li></li></ul></nav>";
            echo "</header>";
        }
        function footer(){
            echo "<footer>";
            echo "<p>Bolje vas nasli</p>";
            echo "</footer>";
        }
        function menu(){
            echo "<ul class='group'>";
                echo "<li><a href='index.php?grupa=Milka'>Milka</a></li>";
                echo "<li><a href='index.php?grupa=Najlepse zelje'>Najlepse zeljee</a></li>";
